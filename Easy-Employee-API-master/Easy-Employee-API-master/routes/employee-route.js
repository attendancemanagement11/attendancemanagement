...
router.get('/tasks/assigned', asyncMiddleware(taskController.getTasksForUser)); // List all Tasks
router.put('/tasks/:id/complete', asyncMiddleware(taskController.markTaskAsCompleted)); // List all Tasks
