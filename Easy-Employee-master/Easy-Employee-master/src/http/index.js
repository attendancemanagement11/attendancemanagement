...
export const createTask = data => api.post('admin/task',data);
export const updateTask = (id,data) => api.post(`admin/task/${id}`,data);
export const deleteTask = data => api.post(`admin/task`,data);
export const assignTask = (id,data) => api.post(`admin/task/${id}`,data);
export const getTask = id=> api.get(`admin/task/${id}`);
export const viewAllTasks = id=> api.get(`admin/tasks`);
...
export const getAssignedTasks = data => api.get(`/employee/tasks/assigned`);
export const markTaskAsCompleted = id => api.put(`/employee/tasks/${id}/complete`);
