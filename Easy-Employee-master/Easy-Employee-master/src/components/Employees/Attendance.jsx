...
const Attendance = () => {
  ...
  // Separate attendance data into Present and Absent
  const presentEmployees = attendance.filter(item => item.present === true);
  const absentEmployees = attendance.filter(item => item.present === false);
            ...
            <section className="section">
              <div className="card">
                <div className="card-header d-flex justify-content-between">
                  <h4>Attendance</h4>
                  <button className={`btn btn-lg ${isAttendanceMarked ? "btn-secondary" : "btn-primary"} btn-icon-split`} onClick={markAttendance}>
              ...
              <div className="d-flex justify-content-center w-100">
                <div className="col">
                  <select className='form-control select2' value={selectedYear} onChange={(e) => setSelectedYear(e.target.value)}>
                ...
                <div className="col">
                  <select className='form-control select2' value={selectedMonth} onChange={(e) => setSelectedMonth(e.target.value)}>
                ...
                <div className="col">
                  <select className='form-control select2' value={selectedDay} onChange={(e) => setSelectedDay(e.target.value)}>
            ...
            {presentEmployees.length > 0 && (
              <div className="table-responsive">
                ...
                <table className="table table-striped table-md center-text">
                  ...
                  <tbody>
                    {presentEmployees.map((attendance, idx) => (
                      <tr key={idx}>
                        <td>{idx + 1}</td>
            ...
            {absentEmployees.length > 0 && (
              <div className="table-responsive">
                ...
                <table className="table table-striped table-md center-text">
                  ...
                  <tbody>
                    {absentEmployees.map((attendance, idx) => (
                      <tr key={idx}>
                        <td>{idx + 1}</td>
                        <td>{attendance.date}/{attendance.month}/{attendance.year}</td>
                        <td>{attendance.day}</td>
