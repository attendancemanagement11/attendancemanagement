...
const LeaveView = () => {
  ...
  useEffect(()=>{
    ...
    const fetchEmployees = async () => {
      try {
          const empObj = {}; // Initialize empObj to store employee data safely
  
          // Fetch employees and leaders
          const emps = await getEmployees();
          const leaders = await getLeaders();
  
          // Safely handle the employees data
          if (emps?.data?.length) {
          ...
          // Safely handle the leaders data
          ...
          // Update state with combined employee and leader data
          ...
          setEmployeeMap({}); // Reset employee map
          setEmployees([]);   // Reset employee list
      }
  };
